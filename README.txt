This is now obsolete now that I have learned that Nessus allows exceptions if you put an exclamation point in front of it. 
For example, if you input the following:
192.168.0.0/16, !192.168.5.0/24, 10.10.10.0/24

You will only scan the following:
192.168.0.0/16, 10.10.10.0/24
